...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "AwesomeWaifu",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "AwesomeWaifu",
    ...
    "welcome_sign": "Welcome to AwesomeWaifu",

    # Copyright on the footer
    "copyright": "WibuUnited",
    ...
    "order_with_respect_to": ["auth", "myapp", "myapp.CustomerUser"],
